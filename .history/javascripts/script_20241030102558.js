...
calculateButton.addEventListener('click', () => {
  console.log(IntegerConverter(mortgageAmountElement.value));
  console.log(IntegerConverter(mortgageTermElement.value));
  console.log(IntegerConverter(mortgageInterestElement.value));
